...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		//3: pop room4 C233854ec915896953f23db06c6283ee8
		if($event['source']['userId'] == 'Ub5f45b12f0f8f8a3a08e5b52ebbcc96b' || $event['source']['groupId'] == 'Cb6942ed51d87f590d8c289478f4b517d' || $event['source']['groupId'] == 'C90392ece5d6b6e69b8a2619e36e018f6' || $event['source']['groupId'] == 'C7eb1d9d359ca234aa91de883c1fe2a4a' || $event['source']['groupId'] == 'Cebf06fc279e81c0f80518bbcd5c03067' || $event['source']['groupId'] == 'Cb07e6ef503794c6e9a7fb0fedb324b07' || $event['source']['groupId'] == 'Cd79d1bc113f459056f31193db6b5b321'
		|| $event['source']['groupId'] == 'C233854ec915896953f23db06c6283ee8')
		{
				...
				if ($event['type'] == 'message' && $event['message']['type'] == 'text') 
				{
						...
						if($arr1[0] == "#")
						{
							...
							if($result <= 1)
							{
								...
								{
									$room='Ub5f45b12f0f8f8a3a08e5b52ebbcc96b';
